...
Repositorio que contiene un proyecto inspirado en Spotify, elaborada con Astro, un avanzado generador de sitios front-end que brinda un rendimiento excepcionalmente veloz. Esta creación no solo es un proyecto técnico intrigante, sino también una valiosa herramienta educativa en la cuál pude plasmar conocimento que hace al ciclo de vida de una webapp.
